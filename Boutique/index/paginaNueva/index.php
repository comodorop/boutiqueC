...
$cn = new coneccion();
$sqlDameImagenesSlider = "SELECT * FROM imgslider";
$dato = mysql_query($sqlDameImagenesSlider, $cn->Conectarse());
if ($dato == false) {
    ...
    <body>
        ...
        <div class="container headerOffset globalPaddingBottom"> 
            <div class=" image-show-case-wrapper center-block relative col-lg-12">
                <div id="imageShowCase" class="owl-carousel owl-theme">
                    <?php while ($rs = mysql_fetch_array($dato)) { ?>
                        <div class="product-slide">
                            ...
                            <a href="#"><img class="img-responsive" src="../<?php echo $rs["ruta"]; ?>" alt="img"></a> 
                        </div>
                        <!-- /.product-slide  -->
                    <?php } ?>
                </div>
        ...
        <div class="container main-container"> 
            <div class="morePost row featuredPostContainer style2" >
                <div class="col-lg-12">
                    <h3 class="boxes-title-1"><span>NUESTROS PRODUCTOS</span></h3>
                </div>
                <div class="container">
                    ...
                    <div class="row">
                        <div class="load-more-block text-center"> 
                            <a class="btn btn-thin" href="#"> 
                                <i class="fa fa-plus-sign">+</i> Ver mas productos</a> 
                        </div>
                    </div>
                </div>
                <!--/.container--> 
            ...
            <div class="width100 section-block">
                <h3 class="section-title"><span>NUESTRAS MARCAS</span> <a id="nextBrand" class="link pull-right carousel-nav"> <i class="fa fa-angle-right"></i></a> <a id="prevBrand" class="link pull-right carousel-nav"> <i class="fa fa-angle-left"></i> </a> </h3>
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="parallax-content clearfix">
                                <h1 class="xlarge"> Mas de 500+ marcas de ropa Americana </h1>
        ...
        <footer>
                        ...
                        <div class="col-lg-3  col-md-3 col-sm-4 col-xs-6">
                            ...
                            <ul>
                                <li class="supportLi">
                                    ...
                                    <h4> <a class="inline" href="ventas@kolash.com"> <i class="fa fa-envelope-o"> </i> ventas@kolash.com </a> </h4>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p class="pull-left"> &copy; PC ORIENTE 2014. All right reserved. </p>
