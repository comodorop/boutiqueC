...
echo"<div class='table-responsive' ><table class='table table-hover' id='dtclasificados'><thead><th>Codigo Producto</th><th>Nombre</th><th>Tipo</th><th>Imagenes</th></thead><tbody>";
