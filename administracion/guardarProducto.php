...
$colores = json_decode(stripcslashes($_GET["colores"]));
...
$producto->setMaterial($_GET["material"]);
...
if ($datos == false) {
    ...
    if ($datos2 == false) {
        $dao->guardarProducto($producto, $costo, $tarifa, $idsucursal, "0", $colores,$tipoProducto);
        if ($granel == 1) {
