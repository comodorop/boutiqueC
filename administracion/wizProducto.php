...
<html lang="es">
    <body>
                    ...
                    <form id="formularioProductos">
                        <div id="formulario">
                            ...
                            <div id="divgrande">
                                ...
                                <div class="form-group form-inline">
                                    <label>Talla de la prenda</label><br/>
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <select id="tipoProducto" style="width: 40%; height: 35px" class="selectpicker selectores" data-container="body" data-live-search="true">
                                    </select>
                                    <input type="button" class="btn btn-cprimary" data-dismiss="modal" data-toggle="modal" 
                                           data-target="#mdlTipoProducto" value="+"/>
                                </div>
                                <div class="form-group form-inline">
                                    <label>Tipo de material:</label><br/>
                                    <select id="selectMaterial" style="width: 40%; height: 35px" class="selectpicker selectores" data-container="body" data-live-search="true">
                                    </select>
                                    <input type="button" 
                                           class="btn btn-cprimary" data-dismiss="modal" data-toggle="modal" data-target="#mdlTipoTipoProducto" value="+"/>
                                </div>
                                <div class="form-group form-inline">
                                    <table>
                                        <thead>
        ...
        <div class="modal fade" id="mdlGrupoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabel">Nueva Talla</h4>
                    </div>
                    <form>
                        <div class="modal-body">
                            <div class="form-group">
                    ...
                    <form>
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtnombreGrupoTipo" >
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input id="cancelGrupo" type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar"/>
        ...
        <div class="modal fade" id="mdlTipoTipoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    ...
                    <form>
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtnombreMaterial" >
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input id="cancelGrupo" type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar"/>
                            <input id="btnGuardarMaterial" type="button" class="btn btn-cprimary" data-dismiss="modal" value="Guardar" />
                        </div>
                    </form>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
    ...
    <script src="administracion.js/material.js"></script>
